/**
 * Created by sharatk on 8/3/2018.
 */
var mxgraph_req = require('mxgraph-js');
//var Editor = require('./mxgraph/Editor')
...
var modifyCreateShape = function () {
    ...
    if (state.style != null) {
      ...
      if (shape != null && shape.substring(0, 8) == 'stencil(') {
        try {
          ...
          var doc = mxUtils.parseXml(zapGremlins(decodeURIComponent(stencil)));
...
var mxVsdxCodec = (function () {
  ...
  mxVsdxCodec.prototype.decodeVsdx = function (file, inp_graph, callback, charset, onerror) {
    var _this = this;
    var docData = ({});
    var mediaData = ({});
    ...
    var allDone = function () {
      ...
      _this.vsdxModel = new mxVsdxModel(rootDoc, docData, mediaData);
      modifyCreateShape();
      inp_graph.setConstrainChildren(false);
        ...
        var _loop_1 = function (index121) {
          var entry = array122[index121];
          {
            ...
            if (!page_1.isBackground()) {
              inp_graph.getModel().beginUpdate();
              this_1.importPage(page_1, inp_graph, inp_graph.getDefaultParent());
              var backPage = page_1.getBackPage();
              if (backPage != null) {
                inp_graph.getModel().setValue(inp_graph.getDefaultParent(), page_1.getPageName());
                var backCell = new mxCell(backPage.getPageName());
                inp_graph.addCell(backCell, inp_graph.getModel().getRoot(), 0, null, null);
                this_1.importPage(backPage, inp_graph, inp_graph.getDefaultParent());
              }
              var scale = page_1.getPageScale() / page_1.getDrawingScale();
              if (scale !== 1) {
                var model = inp_graph.getModel();
                {
              ...
              inp_graph.getModel().endUpdate();
              /* append */
              (function (sb) {
                return sb.str = _this.processPage(inp_graph, page_1);
              })(xmlBuilder);
            }
          }
        };
                  ...
                  zipEntry.async("uint8array").then(function (emfData) {
                    ...
                    for (var i = 0; i < emfData.length - 8; i++) {
                      if (_this.isPng(emfData, i) || _this.isJpg(emfData, i)) {
                        base64Str = mxBase64.encodeToString(emfData, i);
                        imageFound = true;
                        break;
                      }
                    }
  ...
  /*private*/
  mxVsdxCodec.prototype.isJpg = function (emfData, i) {
    return emfData[i] === (255 | 0) && emfData[i + 1] === (216 | 0) && emfData[i + 2] === (255 | 0);
  };
  /*private*/
  mxVsdxCodec.prototype.isPng = function (emfData, i) {
   ...
   * @param {mxVsdxPage} page Actual page Element to be imported
  ...
  mxVsdxCodec.prototype.importPage = function (page, graph, parent) {
    ...
    while ((it.hasNext())) {
      ...
      if (edgeShapeEntry.getKey().getPageNumber() === pageId) {
        this.addUnconnectedEdge(graph, /* get */ (function (m, k) {
          if (m.entries == null)
            m.entries = [];
          for (var i = 0; i < m.entries.length; i++)
            if (m.entries[i].key.equals != null && m.entries[i].key.equals(k) || m.entries[i].key === k) {
  ...
  mxVsdxCodec.prototype.addShape = function (graph, shape, parent, pageId, parentHeight) {
    ...
    if (type != null && ((function (o1, o2) {
      ...
      })(type, mxVsdxConstants.TYPE_SHAPE) || (function (o1, o2) {
        if (o1 && o1.equals) {
          return o1.equals(o2);
        }
        else {
      ...
      })(type, mxVsdxConstants.TYPE_GROUP) || (function (o1, o2) {
        if (o1 && o1.equals) {
          return o1.equals(o2);
        }
        else {
      ...
      if (shape.isVertex()) {
        ...
        })(this.vertexShapeMap, new ShapePageId(pageId, id), shape);
        return v1;
      }
      else {
        ...
        })(this.edgeShapeMap, new ShapePageId(pageId, id), shape);
        /* put */
        (function (m, k, v) {
          if (m.entries == null)
            m.entries = [];
        ...
        })(this.parentsMap, new ShapePageId(pageId, id), parent);
      }
    }
    return null;
  };
  ...
  mxVsdxCodec.prototype.addGroup = function (graph, shape, parent, pageId, parentHeight) {
    ...
    var style = mxVsdxUtils.getStyleString(styleMap, "=");
    var group = null;
    ...
    while ((entries.hasNext())) {
      ...
      if (subShape.isVertex()) {
        var type = VsdxShape.getType(subShape.getShape());
        if (type != null && ((function (o1, o2) {
            if (o1 && o1.equals) {
              return o1.equals(o2);
            }
        ...
        if (master == null) {
          ...
          })(this.vertexShapeMap, new ShapePageId(pageId, Id), subShape);
        }
      }
      else {
        if (master == null) {
          ...
          })(this.edgeShapeMap, new ShapePageId(pageId, Id), subShape);
          /* put */
          (function (m, k, v) {
            if (m.entries == null)
              m.entries = [];
          ...
          })(this.parentsMap, new ShapePageId(pageId, Id), group);
        }
        else {
  ...
  mxVsdxCodec.prototype.addVertex = function (graph, shape, parent, pageId, parentHeight) {
    ...
    if (geomExists || textLabel != null) {
      ...
      })(this.vertexMap, new ShapePageId(pageId, shape.getId()), v1);
   ...
   * @param {mxVsdxConnect} connect Connect Element that references an edge shape and the source vertex.
   * @param {number} pageId
  ...
  mxVsdxCodec.prototype.addConnectedEdge = function (graph, connect, pageId, pageHeight) {
    ...
    var edgeId = new ShapePageId(pageId, fromSheet);
    ...
    var parent = (function (m, k) {
      ...
      return null;
    })(this.parentsMap, new ShapePageId(pageId, edgeShape.getId()));
    ...
    var source = sourceSheet != null ? (function (m, k) {
      ...
      return null;
    })(this.vertexMap, new ShapePageId(pageId, sourceSheet)) : null;
    ...
    var target = toSheet != null ? (function (m, k) {
      ...
      return null;
    })(this.vertexMap, new ShapePageId(pageId, toSheet)) : null;
    ...
    if (rotation !== 0) {
      ...
      edge = graph.insertEdge(parent, null, edgeShape.getTextLabel(), source, target, mxVsdxUtils.getStyleString(styleMap, "="));
   ...
   * @param {VsdxShape} edgeShape Shape Element that represents an edge.
        ...
        var comma_1 = (shapesInPages.length === 0) ? "" : ",";
        {
          ...
          var _loop_1 = function (index128) {
            var master = array129[index128];
            {
              ...
              var shape = new VsdxShape(page, shapeElem, !page.isEdge(shapeElem), masterShapes, null, this_1.vsdxModel);
              var cell = null;
              if (shape.isVertex()) {
                /* clear */
      ...
      for (var id in model.cells) {
        var c = model.cells[id];
        {
          if (graph.getDefaultParent() === model.getParent(c)) {
            ...
            var name_1 = "";
            if (style != null) {
              var p = style.indexOf(mxVsdxConstants.VSDX_ID);
              if (p >= 0) {
                ...
                var vsdxShape = (function (m, k) {
                  ...
                  return null;
                })(this_2.vertexShapeMap, new ShapePageId(page.getId(), id));
                if (vsdxShape != null)
...
var mxVsdxModel = (function () {
  function mxVsdxModel(doc, docData, mediaData) {
    ...
    while ((childNode != null)) {
      if ((childNode != null && (childNode.nodeType == 1)) && (function (o1, o2) {
        ...
        })(childNode.tagName.toLowerCase(), mxVsdxCodec.vsdxPlaceholder + "document")) {
  ...
  mxVsdxModel.prototype.initThemes = function () {
    if (this.xmlDocs != null) {
      ...
      var index = 1;
      while ((more)) {
        var path = mxVsdxCodec.vsdxPlaceholder + "/theme/theme" + index + ".xml";
        ...
        if (themeDoc != null) {
          ...
          while ((child != null)) {
            if ((child != null && (child.nodeType == 1)) && (function (o1, o2) {
              ...
              var theme_1 = new mxVsdxTheme(child);
  ...
  mxVsdxModel.prototype.initStylesheets = function () {
    var vdxSheets = this.rootElement.getElementsByTagName(mxVsdxConstants.STYLE_SHEETS);
    if (vdxSheets.length > 0) {
      var sheets_1 = vdxSheets.item(0);
      var sheetList = sheets_1.getElementsByTagName(mxVsdxConstants.STYLE_SHEET);
      var sheetLength = sheetList.length;
      for (var i = 0; i < sheetLength; i++) {
        var sheet = sheetList.item(i);
        var sheetId = sheet.getAttribute(mxVsdxConstants.ID);
        var sheetElement = new Style(sheet, this);
        /* put */
  ...
  mxVsdxModel.prototype.initMasters = function () {
    if (this.xmlDocs != null) {
      var path = mxVsdxCodec.vsdxPlaceholder + "/masters/masters.xml";
      ...
      if (masterDoc != null) {
        ...
        while ((child != null)) {
          if ((child != null && (child.nodeType == 1)) && (function (o1, o2) {
            ...
            })(child.tagName, mxVsdxConstants.MASTERS)) {
            ...
            while ((grandChild != null)) {
              if ((grandChild != null && (grandChild.nodeType == 1)) && (function (o1, o2) {
                ...
                var master = new mxVsdxMaster(masterElement, this);
                /* put */
  ...
  mxVsdxModel.prototype.initPages = function () {
    if (this.xmlDocs != null) {
      var path = mxVsdxCodec.vsdxPlaceholder + "/pages/pages.xml";
      ...
      if (pageDoc != null) {
        ...
        while ((child != null)) {
          if ((child != null && (child.nodeType == 1)) && (function (o1, o2) {
            ...
            })(child.tagName, mxVsdxConstants.PAGES)) {
            var pages = child;
            var pageList = pages.getElementsByTagName(mxVsdxConstants.PAGE);
   ...
   * @return {Style} StyleSheet element with id = 'id' wrapped in an instance of mxStyleSheet.
   */
...
var Style = (function () {
  function Style(shape, model) {
    ...
    var Id = shape.getAttribute(mxVsdxConstants.ID);
    try {
  ...
  Style.prototype.stylesheetRefs = function (model) {
    /* put */
    (this.styleParents[mxVsdxConstants.FILL_STYLE] = model.getStylesheet(this.shape.getAttribute(mxVsdxConstants.FILL_STYLE)));
    /* put */
    (this.styleParents[mxVsdxConstants.LINE_STYLE] = model.getStylesheet(this.shape.getAttribute(mxVsdxConstants.LINE_STYLE)));
    /* put */
    (this.styleParents[mxVsdxConstants.TEXT_STYLE] = model.getStylesheet(this.shape.getAttribute(mxVsdxConstants.TEXT_STYLE)));
      ...
      if (form != null && value != null) {
        if ((function (o1, o2) {
          ...
          if ((function (o1, o2) {
            ...
            })(mxVsdxConstants.LINE_COLOR, key) || (function (o1, o2) {
              if (o1 && o1.equals) {
                return o1.equals(o2);
              }
              else {
            ...
            })(mxVsdxConstants.LINE_PATTERN, key) || (function (o1, o2) {
              if (o1 && o1.equals) {
                return o1.equals(o2);
              }
              else {
            ...
            })(mxVsdxConstants.BEGIN_ARROW_SIZE, key) || (function (o1, o2) {
              if (o1 && o1.equals) {
                return o1.equals(o2);
              }
              else {
            ...
            })(mxVsdxConstants.END_ARROW_SIZE, key) || (function (o1, o2) {
              if (o1 && o1.equals) {
                return o1.equals(o2);
              }
              else {
            ...
            })(mxVsdxConstants.BEGIN_ARROW, key) || (function (o1, o2) {
              if (o1 && o1.equals) {
                return o1.equals(o2);
              }
              else {
            ...
            })(mxVsdxConstants.END_ARROW, key) || (function (o1, o2) {
              if (o1 && o1.equals) {
                return o1.equals(o2);
              }
              else {
  ...
  Style.prototype.getNameU = function () {
    return this.shape.getAttribute(mxVsdxConstants.NAME_U) || "";
  };
  /**
  ...
  Style.prototype.getName = function () {
    return this.shape.getAttribute(mxVsdxConstants.NAME) || "";
  };
  /**
  ...
  Style.prototype.getUniqueID = function () {
    return this.shape.getAttribute(mxVsdxConstants.UNIQUE_ID) || "";
  };
  /**
...
var Shape = (function (_super) {
  ...
  Shape.prototype.processGeomList = function (parentGeoList) {
    if (!this.geomListProcessed) {
      this.geomList = new mxVsdxGeometryList(parentGeoList);
      if (this.geom != null) {
  ...
  Shape.prototype.parseShapeElem = function (elem, model) {
    ...
    if ((function (o1, o2) {
            ...
            if (rid != null && !(rid.length === 0)) {
              ...
              if (relElem != null) {
                ...
                if (type != null && (function (str, searchString) {
                  ...
                  this.imageData = ({});
                  var iData = model.getMedia(mxVsdxCodec.vsdxPlaceholder + "/media/" + target);
                  if (!iData) {
                    /* put */
      ...
      })(childName, mxVsdxConstants.TEXT)) {
      this.text = elem;
    }
  };
  /**
  ...
  Shape.prototype.parseSection = function (elem) {
    ...
    if ((function (o1, o2) {
      ...
      var rows = mxVsdxUtils.getDirectChildNamedElements(elem, "Row");
      for (var index157 = 0; index157 < rows.length; index157++) {
        var row = rows[index157];
        {
          ...
          if (!(ix.length === 0)) {
            ...
            var cells = mxVsdxUtils.getDirectChildNamedElements(row, "Cell");
            var value = "";
            var format = "";
            var calendar = "";
            var type = "";
  ...
  Shape.prototype.getTextCharFormated = function (text) {
    ...
    text = this.isBold(this.cp) ? mxVsdxUtils.surroundByTags(text, "b") : text;
    text = this.isItalic(this.cp) ? mxVsdxUtils.surroundByTags(text, "i") : text;
    text = this.isUnderline(this.cp) ? mxVsdxUtils.surroundByTags(text, "u") : text;
    text = this.getTextStrike(this.cp) ? mxVsdxUtils.surroundByTags(text, "s") : text;
    text = this.isSmallCaps(this.cp) ? mxVsdxUtils.toSmallCaps(text, this.getTextSize(this.cp)) : text;
  ...
  Shape.prototype.insertAttributes = function (text, attr) {
    if (text.indexOf(">") != -1) {
      ...
      var style = " style=\"" + mxVsdxUtils.getStyleString(attr, ":") + "\"";
...
var VsdxShape = (function (_super) {
  ...
  function VsdxShape(page, shape, vertex, masters, master, model) {
    ...
    var shapesList = shape.getElementsByTagName(mxVsdxConstants.SHAPES);
...
//            			mxResources.add("/js/vsdx/resources/nameU");
  ...
  VsdxShape.prototype.getGradient = function () {
    ...
    if ((function (o1, o2) {
      ...
      if (fillGradient != null) {
        var rows = mxVsdxUtils.getDirectChildNamedElements(fillGradient.elem, "Row");
  ...
  VsdxShape.prototype.getStyleFromShape = function () {
    /* put */
    (this.styleMap[mxVsdxConstants.VSDX_ID] = this.getId().toString());
    ...
    var opacity = this.getOpacity(mxVsdxConstants.FILL_FOREGND_TRANS);
    if (opacity < 100) {
      /* put */
    ...
    if (this.isShadow()) {
      /* put */
      (this.styleMap[mxConstants.STYLE_SHADOW] = mxVsdxConstants.TRUE);
    }
  ...
  VsdxShape.prototype.getMasterId = function () {
    if (this.shape.hasAttribute(mxVsdxConstants.MASTER)) {
      return this.shape.getAttribute(mxVsdxConstants.MASTER);
    }
    else {
      return null;
    }
  ...
  VsdxShape.prototype.getShapeMasterId = function () {
    if (this.shape.hasAttribute(mxVsdxConstants.MASTER_SHAPE)) {
      return this.shape.getAttribute(mxVsdxConstants.MASTER_SHAPE);
    }
    else {
      return null;
    }
  ...
  VsdxShape.prototype.getNameU = function () {
    var result = this.shape.getAttribute(mxVsdxConstants.NAME_U) || "";
  ...
  VsdxShape.prototype.getName = function () {
    var result = this.shape.getAttribute(mxVsdxConstants.NAME);
    if ((result == null || (function (o1, o2) {
        if (o1 && o1.equals) {
          return o1.equals(o2);
        }
  ...
  VsdxShape.prototype.setLabelOffset = function (vertex, style) {
    var nameU = "";
    var masterNameU = "";
    if (this.shape.hasAttribute(mxVsdxConstants.NAME_U)) {
      nameU = this.shape.getAttribute(mxVsdxConstants.NAME_U);
    }
    ...
    if ((function (str, searchString, position) {
      ...
      var control = this.shape.getElementsByTagName(mxVsdxConstants.CONTROL).item(0);
      var xEl = null;
      var xS = "0.0";
      var yEl = null;
      var yS = "-0.4";
      if (control != null) {
        xEl = control.getElementsByTagName(mxVsdxConstants.X).item(0);
        ...
        yEl = control.getElementsByTagName(mxVsdxConstants.Y).item(0);
...
//                        }
    if (this.isVertex()) {
      try {
        ...
        if (this.imageData != null || ((function (o1, o2) {
          ...
          })(mxVsdxConstants.FOREIGN, type) && this.masterShape != null && this.masterShape.imageData != null)) {
  ...
  VsdxShape.prototype.isDisplacedLabel = function () {
    var txtPinXF = this.getAttribute(mxVsdxConstants.TXT_PIN_X, "F", "");
    var txtPinYF = this.getAttribute(mxVsdxConstants.TXT_PIN_Y, "F", "");
    var txtWidthF = this.getAttribute(mxVsdxConstants.TXT_WIDTH, "F", "");
    var txtHeightF = this.getAttribute(mxVsdxConstants.TXT_HEIGHT, "F", "");
    if (this.masterShape != null) {
      if (txtPinXF === "" || (function (o1, o2) {
        ...
        txtPinXF = this.masterShape.getAttribute(mxVsdxConstants.TXT_PIN_X, "F", "");
      }
      if (txtPinYF === "" || (function (o1, o2) {
        ...
        txtPinYF = this.masterShape.getAttribute(mxVsdxConstants.TXT_PIN_Y, "F", "");
      }
      if (txtWidthF === "" || (function (o1, o2) {
        ...
        txtWidthF = this.masterShape.getAttribute(mxVsdxConstants.TXT_WIDTH, "F", "");
      }
      if (txtHeightF === "" || (function (o1, o2) {
        ...
        txtHeightF = this.masterShape.getAttribute(mxVsdxConstants.TXT_HEIGHT, "F", "");
      }
    }
    if ((function (o1, o2) {
        if (o1 && o1.equals) {
  ...
  VsdxShape.prototype.isRotatedLabel = function () {
    var txtAngleValue = this.getAttribute(mxVsdxConstants.TXT_ANGLE, "V", "");
    if (this.masterShape != null) {
      if ((function (o1, o2) {
          if (o1 && o1.equals) {
            return o1.equals(o2);
        ...
        txtAngleValue = this.masterShape.getAttribute(mxVsdxConstants.TXT_ANGLE, "V", "");
      }
    }
    if (!(function (o1, o2) {
        if (o1 && o1.equals) {
  ...
  VsdxShape.prototype.getControlPoints = function (parentHeight) {
    ...
    var pointList = ([]);
    if (this.shape != null) {
      var geomList = this.shape.getElementsByTagName(mxVsdxConstants.GEOM);
      if (geomList.length > 0) {
        var firstGeom = geomList.item(0);
        var firstNURBS = firstGeom.getElementsByTagName(mxVsdxConstants.NURBS_TO).item(0);
  ...
  VsdxShape.prototype.resolveCommonStyles = function () {
    ...
    /* put */
    (this.styleMap[mxConstants.STYLE_ROUNDED] = this.isRounded() ? mxVsdxConstants.TRUE : mxVsdxConstants.FALSE);
    return this.styleMap;
  };
  /**
  ...
  VsdxShape.prototype.createLabelSubShape = function (graph, parent) {
    ...
    if (textLabel != null && !(textLabel.length === 0)) {
      ...
      var style = "text;" + mxVsdxUtils.getStyleString(styleMap, "=");
...
var mxPropertiesManager = (function () {
  ...
  mxPropertiesManager.prototype.initialise = function (elem, model) {
    if (elem != null) {
      var vdxColors = elem.getElementsByTagName(mxVsdxConstants.COLORS);
      if (vdxColors.length > 0) {
        var colors = vdxColors.item(0);
        var colorList = colors.getElementsByTagName(mxVsdxConstants.COLOR_ENTRY);
        var colorLength = colorList.length;
        for (var i = 0; i < colorLength; i++) {
          var color = colorList.item(i);
          var colorId = color.getAttribute(mxVsdxConstants.INDEX);
          var colorValue = color.getAttribute(mxVsdxConstants.RGB);
          /* put */
          (this.colorElementMap[colorId] = colorValue);
        }
        ;
      }
      var vdxFonts = elem.getElementsByTagName(mxVsdxConstants.FACE_NAMES);
      if (vdxFonts.length > 0) {
        var fonts = vdxFonts.item(0);
        var fontList = fonts.getElementsByTagName(mxVsdxConstants.FACE_NAME);
        var fontLength = fontList.length;
        for (var i = 0; i < fontLength; i++) {
          var font = fontList.item(i);
          var fontId = font.getAttribute(mxVsdxConstants.ID);
          var fontValue = font.getAttribute(mxVsdxConstants.FONT_NAME);
          /* put */
...
var mxTheme = {
  Color: (function () {
    ...
    Color.prototype.toHsl = function () {
      ...
      return new mxTheme.HSLColor(h, s, l);
    };
    Color.prototype.toHsv = function () {
      ...
      return new mxTheme.HSVColor(h, s, v);
    };
  ...
  FillStyleFactory: (function () {
    ...
    FillStyleFactory.getFillStyle = function (fillStyle) {
      ...
      switch ((fillStyle.nodeName)) {
        case "a:solidFill":
          fillObj = new mxTheme.SolidFillStyle(mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(fillStyle)));
          break;
        case "a:noFill":
          fillObj = new mxTheme.NoFillStyle();
          break;
        case "a:gradFill":
          fillObj = new mxTheme.GradFill(fillStyle);
          break;
        case "a:blipFill":
          break;
        case "a:pattFill":
  ...
  GradFill: (function () {
    function GradFill(elem) {
      ...
      /*private*/
      this.color2 = null;
      var gsLst = mxVsdxUtils.getDirectChildNamedElements(elem, "a:gsLst");
      if (gsLst.length > 0) {
        var gs = mxVsdxUtils.getDirectChildElements(/* get */ gsLst[0]);
        if (gs.length >= 2) {
          this.color2 = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(/* get */ gs[0]));
          this.color1 = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(/* get */ gs[gs.length - 1]));
        }
      }
      if (this.color1 == null) {
        this.color1 = this.color2 = new mxTheme.SrgbClr("FFFFFF");
      }
    }
  ...
  HSLColor: (function () {
    ...
    HSLColor.prototype.toRgb = function () {
      ...
      return new mxTheme.Color(((r * 255) | 0), ((g * 255) | 0), ((b * 255) | 0));
    };
    /*private*/
  ...
  LineStyle: (function () {
    function LineStyle(elem) {
      ...
      if (((elem != null && (elem.nodeType == 1)) || elem === null)) {
        ...
        this.tailEndWidth = 0;
        this.tailEndLen = 0;
        mxTheme.LineStyle.LineCapType = (function () {
          var LineCapType = {};
        ...
        mxTheme.LineStyle.CompoundLineType = (function () {
          ...
          return CompoundLineType;
        })();
        mxTheme.LineStyle.LineEndType = (function () {
          var LineEndType = {};
        ...
        (function () {
          ...
          var subElems = mxVsdxUtils.getDirectChildElements(elem);
          for (var index153 = 0; index153 < subElems.length; index153++) {
            var subElem = subElems[index153];
            {
              ...
              switch ((name_8)) {
                ...
                case "a:gradFill":
                case "a:pattFill":
                  _this.fillStyle = mxTheme.FillStyleFactory.getFillStyle(subElem);
                  break;
                case "a:prstDash":
                  ...
                  switch ((val)) {
                    ...
                    case "dot":
                      /* add */
                      (_this.lineDashPattern.push(1.0) > 0);
                      /* add */
                      (_this.lineDashPattern.push(4.0) > 0);
                      break;
                    case "sysDash":
                    case "dash":
                      break;
                    case "lgDash":
                      /* add */
                      (_this.lineDashPattern.push(12.0) > 0);
                      /* add */
                      (_this.lineDashPattern.push(4.0) > 0);
                      break;
                    case "sysDashDot":
                    case "dashDot":
                      /* add */
                      (_this.lineDashPattern.push(8.0) > 0);
                      /* add */
                      (_this.lineDashPattern.push(4.0) > 0);
                      /* add */
                      (_this.lineDashPattern.push(1.0) > 0);
                ...
                case "a:custDash":
                  _this.isLineDashed = true;
                  var dsElems = mxVsdxUtils.getDirectChildNamedElements(subElem, "a:ds");
                  for (var index154 = 0; index154 < dsElems.length; index154++) {
                    var dsElem = dsElems[index154];
                    {
                      ...
                      /* add */
                      (_this.lineDashPattern.push(spaceLen / 10000.0) > 0);
                    }
                  }
                  break;
                case "a:round":
  ...
  OoxmlColorFactory: (function () {
    ...
    OoxmlColorFactory.getOoxmlColor = function (element) {
      ...
      switch ((nodeName)) {
        case "a:scrgbClr":
          color = new mxTheme.ScrgbClr(/* parseInt */ parseInt(element.getAttribute("r")), /* parseInt */ parseInt(element.getAttribute("g")), /* parseInt */ parseInt(element.getAttribute("b")));
          break;
        case "a:srgbClr":
          color = new mxTheme.SrgbClr(element.getAttribute("val"));
          break;
        case "a:hslClr":
          color = new mxTheme.HslClr(/* parseInt */ parseInt(element.getAttribute("hue")), /* parseInt */ parseInt(element.getAttribute("sat")), /* parseInt */ parseInt(element.getAttribute("lum")));
          break;
        case "a:sysClr":
          color = new mxTheme.SysClr(element.getAttribute("val"), element.getAttribute("lastClr"));
          break;
        case "a:schemeClr":
          color = new mxTheme.SchemeClr(element.getAttribute("val"));
          break;
        case "a:prstClr":
          color = new mxTheme.SrgbClr(element.getAttribute("val"));
          break;
      }
      var effects = mxVsdxUtils.getDirectChildElements(element);
...
mxTheme.HslClr = (function (_super) {
...
mxTheme.PrstClr = (function (_super) {
  __extends(PrstClr, _super);
  function PrstClr(val) {
    var _this = _super.call(this) || this;
    _this.val = null;
    _this.val = val;
    _this.color = new mxTheme.Color(255, 255, 255);
    return _this;
  }

  return PrstClr;
}(mxTheme.OoxmlColor));
mxTheme.SchemeClr = (function (_super) {
...
mxTheme.ScrgbClr = (function (_super) {
  ...
  function ScrgbClr(r, g, b) {
    ...
    _this.g = g;
    _this.b = b;
    _this.color = new mxTheme.Color(r, g, b);
    return _this;
  }

  return ScrgbClr;
}(mxTheme.OoxmlColor));
mxTheme.SrgbClr = (function (_super) {
  __extends(SrgbClr, _super);
  function SrgbClr(hexVal) {
    var _this = _super.call(this) || this;
    _this.hexVal = null;
    _this.hexVal = hexVal;
    _this.color = mxTheme.Color.decodeColorHex(hexVal);
    return _this;
  }

  return SrgbClr;
}(mxTheme.OoxmlColor));
mxTheme.SysClr = (function (_super) {
...
var mxVsdxTheme = (function () {
  function mxVsdxTheme(theme) {
    ...
    /*private*/
    this.defaultClr = new mxTheme.Color(255, 255, 255);
    /*private*/
    this.defaultLineClr = new mxTheme.Color(0, 0, 0);
    /*private*/
    this.defaultLineStyle = new mxTheme.LineStyle();
    /*private*/
    this.fillStyles = ([]);
    /*private*/
    this.connFillStyles = ([]);
  ...
  mxVsdxTheme.prototype.processExtras = function (element) {
    var exts = mxVsdxUtils.getDirectChildElements(element);
    for (var index134 = 0; index134 < exts.length; index134++) {
      var ext = exts[index134];
      {
        var vt = mxVsdxUtils.getDirectFirstChildElement(ext);
        switch ((vt.nodeName)) {
          case "vt:fmtConnectorScheme":
            ...
            var connSchemes = mxVsdxUtils.getDirectChildElements(vt);
            for (var index135 = 0; index135 < connSchemes.length; index135++) {
              var scheme = connSchemes[index135];
              {
                ...
                switch ((name_3)) {
                  case "a:fillStyleLst":
                    var fillStyleElems = mxVsdxUtils.getDirectChildElements(scheme);
                    for (var index136 = 0; index136 < fillStyleElems.length; index136++) {
                      var fillStyle = fillStyleElems[index136];
                      {
                        /* add */
                        (this.connFillStyles.push(mxTheme.FillStyleFactory.getFillStyle(fillStyle)) > 0);
                      }
                    }
                    break;
                  case "a:lnStyleLst":
                    var lineStyleElems = mxVsdxUtils.getDirectChildElements(scheme);
                    for (var index137 = 0; index137 < lineStyleElems.length; index137++) {
                      var lineStyle = lineStyleElems[index137];
                      {
                        /* add */
                        (this.connLineStyles.push(new mxTheme.LineStyle(lineStyle)) > 0);
                      }
                    }
                    break;
                }
            ...
            break;
          case "vt:lineStyles":
            var styles = mxVsdxUtils.getDirectChildElements(vt);
              ...
              var style = styles[index138];
              {
                ...
                switch ((name_4)) {
                  case "vt:fmtConnectorSchemeLineStyles":
                    var connStylesElems = mxVsdxUtils.getDirectChildElements(style);
                    for (var index139 = 0; index139 < connStylesElems.length; index139++) {
                      var connStyle = connStylesElems[index139];
                      {
                        /* add */
                        (this.connLineStylesExt.push(new mxTheme.LineStyleExt(connStyle)) > 0);
                      }
                    }
                    break;
                  case "vt:fmtSchemeLineStyles":
                    var schemeStyleElems = mxVsdxUtils.getDirectChildElements(style);
                    for (var index140 = 0; index140 < schemeStyleElems.length; index140++) {
                      var schemeStyle = schemeStyleElems[index140];
                      {
                        /* add */
                        (this.lineStylesExt.push(new mxTheme.LineStyleExt(schemeStyle)) > 0);
                      }
                    }
                    break;
                }
          ...
          case "vt:fontStylesGroup":
            var fontStyleElems = mxVsdxUtils.getDirectChildElements(vt);
          ...
          case "vt:variationStyleSchemeLst":
            var varStyleSchemes = mxVsdxUtils.getDirectChildElements(vt);
            var i = 0;
  ...
  mxVsdxTheme.prototype.fillFontStyles = function (fontStyle, fontColors, fontStyles) {
    var fontProps = mxVsdxUtils.getDirectChildElements(fontStyle);
  ...
  mxVsdxTheme.prototype.processFormats = function (element) {
    var styles = mxVsdxUtils.getDirectChildElements(element);
    for (var index145 = 0; index145 < styles.length; index145++) {
      var style = styles[index145];
      {
        ...
        switch ((name_6)) {
          case "a:fillStyleLst":
            var fillStyleElems = mxVsdxUtils.getDirectChildElements(style);
            for (var index146 = 0; index146 < fillStyleElems.length; index146++) {
              var fillStyle = fillStyleElems[index146];
              {
                /* add */
                (this.fillStyles.push(mxTheme.FillStyleFactory.getFillStyle(fillStyle)) > 0);
              }
            }
            break;
          case "a:lnStyleLst":
            var lineStyleElems = mxVsdxUtils.getDirectChildElements(style);
            for (var index147 = 0; index147 < lineStyleElems.length; index147++) {
              var lineStyle = lineStyleElems[index147];
              {
                /* add */
                (this.lineStyles.push(new mxTheme.LineStyle(lineStyle)) > 0);
              }
            }
            break;
  ...
  mxVsdxTheme.prototype.processColors = function (element) {
    ...
    while ((child != null)) {
      if (child != null && (child.nodeType == 1)) {
        var elem = child;
        var nodeName = elem.nodeName;
        var children = mxVsdxUtils.getDirectChildElements(elem);
        if ((function (o1, o2) {
            if (o1 && o1.equals) {
              return o1.equals(o2);
            }
  ...
  mxVsdxTheme.prototype.addVariantColors = function (element) {
    var parent = mxVsdxUtils.getDirectFirstChildElement(element);
    if (parent != null) {
      var variants = mxVsdxUtils.getDirectChildElements(parent);
      var i = 0;
  ...
  mxVsdxTheme.prototype.addVariantColorsSet = function (index, variant) {
    var colors = mxVsdxUtils.getDirectChildElements(variant);
    ...
    for (var index149 = 0; index149 < colors.length; index149++) {
      var color = colors[index149];
      {
        ...
        switch ((name_7)) {
          case "vt:varColor1":
            this.variantsColors[index][0] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
          case "vt:varColor2":
            this.variantsColors[index][1] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
          case "vt:varColor3":
            this.variantsColors[index][2] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
          case "vt:varColor4":
            this.variantsColors[index][3] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
          case "vt:varColor5":
            this.variantsColors[index][4] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
          case "vt:varColor6":
            this.variantsColors[index][5] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
          case "vt:varColor7":
            this.variantsColors[index][6] = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(color));
            break;
        }
      }
    }
  ...
  mxVsdxTheme.prototype.addBkgndColor = function (element) {
    var elem = mxVsdxUtils.getDirectFirstChildElement(element);
    if (elem != null) {
      this.bkgndColor = mxTheme.OoxmlColorFactory.getOoxmlColor(mxVsdxUtils.getDirectFirstChildElement(elem));
    }
  };
  /*private*/
  ...
  mxVsdxTheme.prototype.addBasicColor = function (clrName, element) {
    /* put */
    (this.baseColors[clrName] = mxTheme.OoxmlColorFactory.getOoxmlColor(element));
  };
  ...
  mxVsdxTheme.prototype.getFillColorQuickStyleValsGradient = function (quickStyleVals, getGradient) {
    ...
    if (fillStyle != null) {
      if (getGradient) {
        retColor = (fillStyle != null && fillStyle instanceof mxTheme.GradFill) ? fillStyle.applyStyle(fillColorStyle, this).getGradientClr() : null;
      }
      else {
...
var mxVsdxMaster = (function () {
  ...
  mxVsdxMaster.prototype.processMasterShapes = function (model) {
    ...
    while ((child != null)) {
      if ((child != null && (child.nodeType == 1)) && (function (o1, o2) {
        ...
        var relElem = model.getRelationship(child.getAttribute("r:id"), mxVsdxCodec.vsdxPlaceholder + "/masters/_rels/masters.xml.rels");
        var target = relElem.getAttribute("Target");
        var type = relElem.getAttribute("Type");
        var masterDoc = null;
        if (type != null && (function (str, searchString) {
      ...
      if ((shapeChild != null && (shapeChild.nodeType == 1)) && (function (o1, o2) {
        ...
        while ((shapesChild != null)) {
          if ((shapesChild != null && (shapesChild.nodeType == 1)) && (function (o1, o2) {
            ...
            var masterShape = new Shape(shape, model);
   ...
   * @return {Shape} First shape in the Master wrapped in a instance of mxMasterShape
   */
   ...
   * @return {Shape} The shape in the master element with ID = 'id' wrapped in a instance of mxMasterShape
   */
...
var mxVsdxPage = (function () {
  function mxVsdxPage(pageElem, model) {
    ...
    var backGround = pageElem.getAttribute(mxVsdxConstants.BACKGROUND);
    ...
    })(backGround, mxVsdxConstants.TRUE)) ? true : false;
    var back = pageElem.getAttribute(mxVsdxConstants.BACK_PAGE);
    if (!this.__isBackground && back != null && back.length > 0) {
      this.backPageId = parseFloat(back);
    }
    this.Id = parseFloat(pageElem.getAttribute(mxVsdxConstants.ID));
    this.pageName = pageElem.getAttribute(mxVsdxConstants.NAME) || "";
    var pageSheets = mxVsdxUtils.getDirectChildNamedElements(pageElem, "PageSheet");
    if (pageSheets.length > 0) {
      var pageSheet = pageSheets[0];
      var cells = mxVsdxUtils.getDirectChildNamedElements(pageSheet, "Cell");
   ...
   * @param {mxVsdxModel} model the model of the vsdx file
    ...
    while ((pageChild != null)) {
      if (pageChild != null && (pageChild.nodeType == 1)) {
        ...
        if ((function (o1, o2) {
          ...
          var connectList = pageChildElem.getElementsByTagName(mxVsdxConstants.CONNECT);
          ...
          while ((connectNode != null)) {
            if (connectNode != null && (connectNode.nodeType == 1)) {
              ...
              var connect = new mxVsdxConnect(connectElem);
              var fromSheet = connect.getFromSheet();
  ...
  mxVsdxPage.prototype.resolveRel = function (relNode, model, pageName) {
    var relElem = model.getRelationship(relNode.getAttribute("r:id"), mxVsdxCodec.vsdxPlaceholder + "/pages/_rels/" + pageName + ".xml.rels");
    var target = relElem.getAttribute("Target");
    var type = relElem.getAttribute("Type");
    if ((function (str, searchString) {
        var pos = str.length - searchString.length;
  ...
  mxVsdxPage.prototype.parseShapes = function (shapesElement, master, recurse) {
    var shapes = ({});
    var shapeList = shapesElement.getElementsByTagName(mxVsdxConstants.SHAPE);
    ...
    while ((shapeNode != null)) {
      if (shapeNode != null && (shapeNode.nodeType == 1)) {
        ...
        if (masterTmp == null) {
          var masterId = shapeElem.getAttribute(mxVsdxConstants.MASTER);
        ...
        if (!isEdge && masterTmp != null) {
          var masterId = shapeElem.getAttribute(mxVsdxConstants.MASTER_SHAPE);
...
var Section = (function () {
  ...
  Section.prototype.getIndexedCell = function (index, cellKey) {
    var rows = mxVsdxUtils.getDirectChildNamedElements(this.elem, "Row");
...
var mxVsdxGeometryList = (function () {
  ...
  mxVsdxGeometryList.prototype.addGeometry = function (geoElem) {
    var geo = new mxVsdxGeometry(geoElem, this.parentGeomList);
        ...
        if (!geo.isNoShow()) {
          ...
          for (var index129 = 0; index129 < rows.length; index129++) {
            var row = rows[index129];
            {
              ...
              if (index129 == 0 && row != null && row instanceof mxVsGeometry.MoveTo) {
                offsetX = row.x != null ? row.x : 0;
                offsetY = row.y != null ? row.y : 0;
              }
              else if (row != null && row instanceof mxVsGeometry.LineTo) {
...
var mxVsdxConnect = (function () {
  function mxVsdxConnect(connectElem) {
    ...
    this.fromCell = null;
    this.endShape = null;
    var fromSheet = connectElem.getAttribute(mxVsdxConstants.FROM_SHEET);
    this.fromSheet = (fromSheet != null && !(fromSheet.length === 0)) ? parseFloat(fromSheet) : -1;
    var fromCell = connectElem.getAttribute(mxVsdxConstants.FROM_CELL);
    this.addFromCell(connectElem, fromCell);
  }

  mxVsdxConnect.prototype.addFromCell = function (connectElem, fromCell) {
    var toSheet = connectElem.getAttribute(mxVsdxConstants.TO_SHEET);
    var source = true;
    if (fromCell != null && (function (o1, o2) {
      ...
      })(fromCell, mxVsdxConstants.BEGIN_X)) {
      ...
      })(fromCell, mxVsdxConstants.END_X)) {
  ...
  mxVsdxConnect.prototype.findToPart = function (connectElem, source) {
    var toPartString = connectElem.getAttribute(mxVsdxConstants.TO_PART);
...
var mxVsdxGeometry = (function () {
  ...
  mxVsdxGeometry.prototype.processGeoElem = function (elem) {
    var cellElems = mxVsdxUtils.getDirectChildNamedElements(elem, "Cell");
    var rowElems = mxVsdxUtils.getDirectChildNamedElements(elem, "Row");
    if (this.rows == null) {
      this.rows = ([]);
    ...
    for (var index123 = 0; index123 < rowElems.length; index123++) {
      ...
      {
        var row = mxVsGeometry.RowFactory.getRowObj(rowElem, this.rows);
  ...
  RowFactory: (function () {
    ...
    RowFactory.getRowObj = function (elem, pRows) {
      ...
      if (!(function (o1, o2) {
        ...
        var cells = mxVsdxUtils.getDirectChildElements(elem);
        ...
        switch ((rowType)) {
          case "MoveTo":
            return new mxVsGeometry.MoveTo(index, x, y);
          case "LineTo":
            return new mxVsGeometry.LineTo(index, x, y);
          case "ArcTo":
            return new mxVsGeometry.ArcTo(index, x, y, a);
          case "Ellipse":
            return new mxVsGeometry.Ellipse(index, x, y, a, b, c, d);
          case "EllipticalArcTo":
            return new mxVsGeometry.EllipticalArcTo(index, x, y, a, b, c, d);
          case "InfiniteLine":
            return new mxVsGeometry.InfiniteLine(index, x, y, a, b);
          case "NURBSTo":
            return new mxVsGeometry.NURBSTo(index, x, y, a, b, c, d, formulaE);
          case "PolylineTo":
            return new mxVsGeometry.PolylineTo(index, x, y, formulaA);
          case "RelCubBezTo":
            return new mxVsGeometry.RelCubBezTo(index, x, y, a, b, c, d);
          case "RelEllipticalArcTo":
            return new mxVsGeometry.RelEllipticalArcTo(index, x, y, a, b, c, d);
          case "RelLineTo":
            return new mxVsGeometry.RelLineTo(index, x, y);
          case "RelMoveTo":
            return new mxVsGeometry.RelMoveTo(index, x, y);
          case "RelQuadBezTo":
            return new mxVsGeometry.RelQuadBezTo(index, x, y, a, b);
          case "SplineKnot":
            return new mxVsGeometry.SplineKnot(index, x, y, a);
          case "SplineStart":
            return new mxVsGeometry.SplineStart(index, x, y, a, b, c, d);
        }
      }
      return new mxVsGeometry.DelRow(index);
    };
    return RowFactory;
  }())
}

mxVsGeometry.ArcTo = (function (_super) {
...
mxVsGeometry.DelRow = (function (_super) {
...
mxVsGeometry.Ellipse = (function (_super) {
...
mxVsGeometry.EllipticalArcTo = (function (_super) {
  ...
  EllipticalArcTo.prototype.handle = function (p, shape) {
    if (this.x != null && this.y != null && this.a != null && this.b != null && this.c != null && this.d != null) {
      ...
      var sf = (sweep > 0) ? "0" : "1";
      var laf = "0";
      if (mxVsdxUtils.isInsideTriangle(p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) && this.isReflexAngle(p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y)) {
        laf = "1";
      }
      shape.setLastX(x);
      shape.setLastY(y);
...
mxVsGeometry.RelEllipticalArcTo = (function (_super) {
...
}(mxVsGeometry.EllipticalArcTo));
mxVsGeometry.InfiniteLine = (function (_super) {
...
mxVsGeometry.LineTo = (function (_super) {
...
mxVsGeometry.MoveTo = (function (_super) {
...
mxVsGeometry.NURBSTo = (function (_super) {
...
mxVsGeometry.NURBSTo.Nurbs = (function () {
  function Nurbs(__parent, s, w, h) {
    ...
    for (var i = 0; i < n.length; i++) {
      if ((i > 3) && (i % 4 === 0)) {
        /* add */
        (this.nurbsValues.push(/* parseDouble */ parseFloat(/* get */ n[i]) * 100.0) > 0);
      }
      else if ((i > 3) && (i % 4 === 1)) {
        /* add */
        (this.nurbsValues.push(100 - parseFloat(/* get */ n[i]) * 100.0) > 0);
      }
      else {
        /* add */
        (this.nurbsValues.push(/* parseDouble */ parseFloat(/* get */ n[i])) > 0);
      }
    }
    ;
  }
...
mxVsGeometry.PolylineTo = (function (_super) {
...
mxVsGeometry.RelCubBezTo = (function (_super) {
...
mxVsGeometry.RelLineTo = (function (_super) {
...
mxVsGeometry.RelMoveTo = (function (_super) {
...
mxVsGeometry.RelQuadBezTo = (function (_super) {
...
mxVsGeometry.SplineKnot = (function (_super) {
...
mxVsGeometry.SplineStart = (function (_super) {
...
module.exports = function doImportVisio(file, graph, done, onerror) {
  if (file.name != null && /(\.vssx)($|\?)/i.test(file.name)) {
    new mxVssxCodec().decodeVssx(file, done);
  }
  else {
    new mxVsdxCodec().decodeVsdx(file, graph, done, null, onerror);
  }
};
